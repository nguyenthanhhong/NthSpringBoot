...
<div class="page-content container-fluid">
    <div class="panel">
        <form name="frmSearch" id="frmSearch">
            <table>
                <tr>
                    <th><span class="star"></span><spring:message code="label code" /></th>
                    <td>
                        <input type="text" class="form-control" name="S_P_LABEL_NM" id="S_P_LABEL_NM" />
                    </td>
                    <th><span class="star"></span><spring:message code="label name" /></th>
                    <td>
                        <input type="text" class="form-control" name="S_LABEL_NM" id="S_LABEL_NM" />
                    </td>
            ...
            <div class="panel">
                <div class="panel-heading pdt-8">
                    <h5 class="panel-title">
                        <i class="fa fa-chevron-circle-right"></i>Label List
                    </h5>
                    <div class="panel-actions">
                        <button type="button" class="btn btn-icon btn-danger btn-sm" onclick="btnAddLabelClick()"><i class="icon fa fa-plus" aria-hidden="true"></i></button>
                        <button type="button" class="btn btn-icon btn-danger btn-sm" onclick="btnDelLabelClick()"><i class="icon fa fa-minus" aria-hidden="true"></i></button>
                    </div>
                </div>
...
<script>
    ...
    function button1OnClick(){
        var input = {
            ...
            type : "SQL_MULTI",
            params : {
                function:"LabelService.getLabelList",
    ...
    function button2OnClick(){
        var input = {
            ...
            type : "SQL_UPDATE",
            params : {
                function: "LabelService.saveLabel",
    ...
    function searchdetail(id){
        ...
        var input = {
            ...
            type : "SQL_MULTI",
            params : {
                function: "LabelService.getLangByLabel",
                data: {LABEL_CD: id}
            },
            callBack : tranCallBack,
            isLoad : true,
    ...
    function btnAddLangClick(){
        ...
        $(langList).each(function(index, element) {
            var newItem = {
                LABEL_CD : row[0].LABEL_CD,
                LABEL_NM : row[0].LABEL_NM,
